...
echo "  - Restore agent-* CLI config (needs the age passphrase):"
echo "      ./setup.sh --secrets-open   # picks/asks this machine's profile"
echo "      ./setup.sh --reauth         # then authenticate each tool listed"
